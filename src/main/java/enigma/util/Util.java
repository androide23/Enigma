...
public class Util {
	...
	public static String language = Enigma.getSystemProperty("attributes.language.default");
	public static String country = Enigma.getSystemProperty("attributes.country.default");
    ...
    public static final String msg(Class<?> clazz, String msgKey) {
        ...
        try {
            ...
            String resource = "/i18n/" + System.getProperty("user.language") + "/" + System.getProperty("user.country") + "/messages/" + clazz.getName().replace('.', '/') + ".properties";
            Path path = Paths.get(resource);
            
            if(!Files.exists(path, LinkOption.NOFOLLOW_LINKS))
            	resource = "/i18n/" + language + "/" + country + "/messages/" + clazz.getName().replace('.', '/') + ".properties";
